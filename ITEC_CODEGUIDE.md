...
| **P2** | `DOCS_CONTEXT` local (docsContext.ts autogenerado) | ≥ 0.22 | Chunking 900/120 + scoring overlap de tokens estilo Jaccard modificado `|A∩B|/min(|A|,|B|)` con stopwords español. Base en memoria de ~2.48M de caracteres generada desde 71 documentos (PDFs y Markdowns estructurados): incluye Memorias y Balances 2022-2023, 2023-2024 y 2024-2025 (ejercicios 79°, 80° y 81° a junio 2025, balances, nómina de autoridades y proyectos), planos viales y sentidos de circulación 2025, Código de Ordenamiento Urbano (COU), ordenanzas y censos de Saladillo Norte, Cazón, Del Carril, Polvaredas, Álvarez de Toledo, anuarios estadísticos N° 1, 2 y 3 año 2025, censos INDEC y datos socioproductivos locales. |
