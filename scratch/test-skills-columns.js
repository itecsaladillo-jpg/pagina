...
const columnsToTest = [
  'skills_disponibles', 'abilities_disponibles', 'knowledge_disponibles',
  'skills_conocimientos', 'skills_tecnicas', 'conocimientos_tecnicos',
  'conocimiento_tecnico', 'habilidad_tecnica', 'competencias_tecnicas',
  'aptitudes_tecnicas', 'habilidades_para_compartir', 'skills_para_compartir',
  'conocimientos_para_compartir', 'habilidades_ofrecidas', 'skills_ofrecidos',
  'conocimientos_ofrecidos', 'habilidades_y_conocimientos_equipo',
  'skills_knowledge_equipo', 'skills_knowledge_itec', 'conocimientos_habilidades_itec',
  'habilidades_y_conocimientos_itec', 'conocimientos_y_habilidades_itec',
  'habilidades_conocimientos_itec', 'habilidades_skills_itec',
...
async function run() {
  console.log('Testing column names with suffix/prefix variations...');
