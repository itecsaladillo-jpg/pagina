...
const columnsToTest = [
  'habilidades_disponibles_itec',
  'conocimientos_disponibles_itec',
  'skills_disponibles_itec',
  'habilidades_miembro_equipo',
  'conocimientos_miembro_equipo',
  'habilidades_equipo_itec',
  'skills_equipo_itec',
  'conocimientos_equipo_itec',
  'habilidades_para_compartir_itec',
  'skills_para_compartir_itec',
  'conocimientos_para_compartir_itec',
  'habilidades_ofrecidas_itec',
  'skills_ofrecidos_itec',
  'conocimientos_ofrecidos_itec',
  'habilidades_y_conocimientos_equipo_itec',
  'skills_knowledge_equipo_itec',
  'habilidades_y_conocimientos_miembro',
  'conocimientos_y_habilidades_miembro',
  'skills_knowledge_member',
  'habilidades_conocimientos_miembro',
  'conocimientos_habilidades_miembro',
  'habilidades_conocimientos_miembros',
  'conocimientos_habilidades_miembros',
  'habilidades_y_conocimientos_miembros',
  'conocimientos_y_habilidades_miembros'
];
...
async function run() {
  console.log('Testing last stand variations...');
