  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f1f5f9;">
    <tr>
      <td align="center" style="padding: 40px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(0,0,0,0.06); overflow: hidden;">
          ...
          <tr>
            <td style="padding: 20px 40px 8px;">
              <h2 style="margin: 0; font-size: 26px; font-weight: 800; color: #0f172a; line-height: 1.3; letter-spacing: -0.02em;">
                ${titulo}
              </h2>
            </td>
          </tr>
          ...
          <!-- Multimedia -->
          ${mediaBlock ? `<tr><td style="padding: 0 40px 24px;">${mediaBlock}</td></tr>` : ''}
