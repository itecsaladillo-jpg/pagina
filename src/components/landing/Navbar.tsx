      ...
      <div className="max-w-7xl mx-auto w-full px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-1.5 ml-auto shrink-0">
          ...
          {dynamicLinks.slice(0, 5).map((link) => {
            return (
              <a
                key={link.href}
                href={link.href}
                className="btn-outline text-[9px] uppercase tracking-wider py-0.5 px-2.5 border-dashed opacity-75 hover:opacity-100 transition-all flex items-center justify-center text-center leading-[1.15] min-h-[32px] whitespace-normal shrink-0 w-auto"
              >
                <span>
                  {link.label.split('\n').map((line, i) => (
          ...
          <a
            ...
            className="text-[9px] uppercase tracking-wider py-0.5 px-2.5 rounded-2xl font-extrabold
              ...
              transition-all duration-200 flex items-center justify-center gap-1.5 min-h-[32px] text-center w-auto whitespace-normal leading-[1.15] shrink-0"
          >
          ...
          {claseEnVivo ? (
            <Link
              ...
              className="text-[9px] uppercase tracking-wider py-0.5 px-2.5 rounded-2xl font-extrabold
                ...
                transition-all duration-200 flex items-center justify-center gap-1.5 min-h-[32px] text-center w-auto whitespace-normal leading-[1.15] shrink-0 animate-pulse"
            >
            ...
            <Link
              href="/clases/demostracion"
              className="btn-outline text-[9px] uppercase tracking-wider py-0.5 px-2.5 border-dashed opacity-75 hover:opacity-100 transition-all flex items-center justify-center text-center min-h-[32px] w-auto whitespace-normal leading-[1.15] shrink-0"
            >
              <span>{dict.navbar.aula}</span>
            </Link>
          )}
