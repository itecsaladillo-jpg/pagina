...
export default function PantallaGigantePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const semaforoActivo = evento.herramientas_activas?.semaforo ?? true
        ...
        <AnimatePresence mode="wait">
          ...
          {evento.modo_pantalla_gigante === 'bienvenida' && (
            <motion.div
              ...
              className="flex flex-col items-center text-center max-w-4xl mx-auto gap-10"
            >
              ...
              <motion.p
                className="text-xl md:text-2xl text-zinc-400 max-w-3xl leading-relaxed font-light"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
