...
export default async function SponsorPortalPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-500 selection:text-black overflow-hidden font-sans relative">
      ...
      <header className="relative z-10 p-8 flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="text-[10px] uppercase tracking-[0.3em] text-gray-500 border-l border-white/20 pl-6 leading-tight">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 pt-16 pb-32">
        ...
        <div className="text-center mb-24 space-y-6">
          <h2 className="text-blue-400 text-xs font-bold uppercase tracking-[0.4em]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {[
            { label: 'Alumnos Alcanzados', value: impact.alumnos || 0 },
            { label: 'Capacitaciones Apoyadas', value: impact.capacitaciones || 0 },
            { label: 'Horas de Formación', value: `${impact.horas || 0}h` },
          ].map((item, i) => (
            <div key={i} className="bg-white/[0.02] backdrop-blur-xl p-10 text-center border border-white/[0.05] rounded-[24px] hover:border-blue-500/30 transition-all group">
              <p className="text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">{item.value}</p>
        ...
        {/* AI Summary Section */}
        <div className="bg-white/[0.02] backdrop-blur-xl p-12 relative overflow-hidden border border-white/10 rounded-[24px]">
