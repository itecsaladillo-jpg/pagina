...
export async function generateMulticanalNews(rawFacts: string): Promise<{
...

  {
    ...
    "texto_miembros": "COMUNICACIÓN INTERNA PARA EL EQUIPO DE ITEC. Tono cercano, directo y entusiasta, escrito en PRIMERA PERSONA DEL PLURAL ('nosotros', 'nuestro'). Reconocimiento del esfuerzo compartido y sentido de pertenencia. IMPORTANTE: separá cada sección con DOS SALTOS DE LINEA (\\n\\n) para generar párrafos diferenciados. (1) ASUNTO motivador y conciso en mayúsculas o con signos de exclamación (ej: '¡Lo logramos! Balance de [Evento]' o 'Gracias por hacer posible [Evento]'). (2) SALUDO cordial al equipo ('Hola equipo', 'Querido equipo'). (3) AGRADECIMIENTO INICIAL explícito: usá la palabra 'gracias' o 'agradecer' para reconocer el compromiso y dedicación humana detrás del éxito (ej: 'Queremos agradecer profundamente...'). (4) RESUMEN DE LOGROS con datos clave (asistentes, alcance, metas cumplidas) en formato lista o párrafo. (5) CITA DE LIDERAZGO breve de la dirección que refuerce el valor del trabajo. (6) INVITACIÓN a revivir momentos (fotos/video en drive) y a compartir comentarios. (7) CIERRE motivador mirando al próximo desafío, con firma institucional ('Un saludo cordial, Equipo ITEC'). Usá emojis naturales (🎉💪✨🚀) sin exagerar. REGLAS: lenguaje inclusivo y cálido, celebrá el logro grupal (nunca concentres el mérito en una sola persona o área), si algo no salió bien mencionalo como 'oportunidad de aprendizaje'. No inventes datos: si falta información, redacta en torno a los hechos disponibles.",
    "texto_sponsors": "INFORME DE RESULTADOS PARA SPONSORS (Reporte de Valor). Tono profesional, orientado a resultados y centrado en el RETORNO DE VALOR (branding y visibilidad). Los sponsors son aliados estratégicos, NO donantes. IMPORTANTE: separá cada sección con DOS SALTOS DE LINEA (\\n\\n) para generar párrafos diferenciados. (1) ASUNTO profesional que incluya nombre del evento y la palabra 'Resultados' o 'Impacto' (ej: 'Informe de Resultados: [Evento] | Gracias por su compromiso con ITEC'). (2) SALUDO formal personalizado ('Estimados/as [Nombre del contacto en la empresa]:'). (3) AGRADECIMIENTO POR LA CONFIANZA en su apoyo, mencionando el evento y fecha. (4) RESUMEN EJECUTIVO (Highlights): datos cuantitativos concretos en formato lista (alcance, asistentes, interacciones en redes, metas cumplidas). (5) VISIBILIDAD DE MARCA: evidencia de dónde y cómo apareció el logo/nombre del sponsor (banners, presentaciones, redes sociales, materiales gráficos, fotos). (6) IMPACTO SOCIAL: qué problema resolvió el evento o qué beneficio concreto trajo a la comunidad. (7) EVIDENCIA ADJUNTA: mencioná explícitamente que se adjunta o comparte un PDF breve (1-2 páginas) con métricas y una carpeta de fotos donde se vea claramente el logo del sponsor. (8) INVITACIÓN A FUTURO: mantener la puerta abierta para próximas alianzas, ofrecer reunión para compartir visión a futuro. Cierre con firma institucional ('Atentamente, [Nombre y cargo]'). REGLAS: enfoque WIN-WIN, nunca los trates como fuente de dinero (usá 'gracias a nuestra alianza', no 'gracias por el dinero'); SIN emojis (es comunicación formal B2B); tercera persona o primera persona institucional. No inventes datos ni métricas: si falta información cuantitativa, redacta en torno a los hechos disponibles y dejá placeholders como [Número] para que el usuario los complete.",
    "texto_medios": "GACETILLA DE PRENSA PARA MEDIOS. Tono periodístico objetivo, sin publicidad encubierta. El periodista debe poder publicarla directamente o usarla como base. IMPORTANTE: separá cada sección con DOS SALTOS DE LINEA (\\n\\n) para generar párrafos diferenciados. (1) ENCABEZADO: 'GACETILLA DE PRENSA – PARA PUBLICACIÓN INMEDIATA'. (2) LUGAR Y FECHA: epígrafe con ciudad y fecha (ej: 'Saladillo, Buenos Aires — [Fecha]'). (3) TITULAR INFORMATIVO: claro y llamativo, sin adjetivos exagerados (evitá 'increíble', 'maravilloso', 'único'). (4) SUBTÍTULO opcional que complemente el titular. (5) LEAD/ENTRADILLA: párrafo de máximo 4 líneas resumiendo las 5W (qué, quién, cuándo, dónde, por qué). (6) CUERPO: detalles del evento, contexto, actividades destacadas. Priorizá hechos concretos. (7) CITA TEXTUAL ATRIBUIBLE de protagonista/autoridad de ITEC, entre comillas dobles, con formato '\"...\", expresó [Nombre y Apellido], [Cargo] de ITEC.' (8) CIERRE: balance final, anuncio a futuro o agradecimiento breve. Mencioná que hay materiales y fotos disponibles para descarga. (9) ACERCA DE ITEC: párrafo de 2-3 líneas describiendo qué es ITEC y qué hace. (10) CONTACTO DE PRENSA con placeholders: 'Nombre: [Nombre del responsable] / Cargo: [Cargo] / Teléfono: [Número] / Correo: [Email] / Web: [URL]'. REGLAS: SIN emojis (es comunicación formal con medios); tercera persona estricta; lenguaje claro y fáctico sin adjetivos subjetivos; nunca uses palabras prohibidas del system prompt; no inventes datos, usá placeholders si falta información.",
  }
